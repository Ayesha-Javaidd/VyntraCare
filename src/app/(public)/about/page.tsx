        ...
        <div className="bg-white border border-[#0A1A33]/10 rounded-3xl p-10 shadow-sm">
          <div className="prose prose-slate prose-lg max-w-none">
            ...
            <p>
              ...
              transparency directly impact patient outcomes, Vyntra Care provides
              a technology-driven solution focused on reliability, intelligence,
              and trust.
            </p>

            <h2 className="text-[#0A1A33]">Our Mission</h2>
            <p>
              Our mission is to eliminate friction from healthcare procurement by
              combining intelligent inventory management, AI-powered demand
            ...
            <h2 className="text-[#0A1A33]">What We Do</h2>
            <p>
            ...
            <h2 className="text-[#0A1A33]">Technology & Innovation</h2>
            <p>
              At the core of Vyntra Care is a scalable, cloud-native architecture
              built specifically for healthcare environments. Our platform
              leverages advanced analytics and artificial intelligence to reduce
              waste, prevent stock shortages, and improve operational efficiency
              across facilities.
            </p>
            ...
            <h2 className="text-[#0A1A33]">Who We Serve</h2>
            <p>
            ...
            <h2 className="text-[#0A1A33]">Our Vision</h2>
            <p>
