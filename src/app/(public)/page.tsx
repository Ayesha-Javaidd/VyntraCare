...
//             <div className="inline-flex items-center gap-2 bg-[#0A1A33]/10 text-[#0A1A33] px-4 py-2 rounded-full border border-[#0A1A33]/20">
...
//               Vyntra Care is the next-generation healthcare supply ecosystem. From subacute management to AI-driven personal respiratory care, we make medical logistics effortless.
//             </p>
...
//                   label="Our AI Vision"
//                   variant="outline"
//                   className="px-10 py-4 text-lg border-[#0A1A33] text-[#0A1A33] hover:bg-[#0A1A33] hover:text-white"
//                 />
//               </Link>
//             </div>
...
//               <div className="flex items-center gap-2 text-sm font-semibold text-[#0A1A33]">
//                 <HeartPulse className="w-6 h-6 text-[#0A1A33]" /> PULSE HEALTH
//               </div>
//               <div className="flex items-center gap-2 text-sm font-semibold text-[#0A1A33]">
//                 <Stethoscope className="w-6 h-6 text-[#0A1A33]" /> MED-ELITE
//               </div>
//               <div className="flex items-center gap-2 text-sm font-semibold text-[#0A1A33] underline underline-offset-4 decoration-[#0A1A33]">
//                 OXIGEN+
//               </div>
//             </div>
//           </div>
...
//                 </div>
//                 <h3 className="text-2xl font-bold text-[#0A1A33]">AI Mask Sizing</h3>
...
//                     label="Try AI Sizer"
//                     variant="outline"
//                     className="w-full border-[#0A1A33] text-[#0A1A33] hover:bg-[#0A1A33] hover:text-white"
...
//             <div className="absolute -bottom-6 -left-6 apple-card p-6 bg-white/90 backdrop-blur max-w-[220px] border border-[#0A1A33]/20 shadow-2xl rounded-xl">
//               <div className="flex items-center gap-1 mb-2">
//                 {[...Array(5)].map((_, i) => (
//                   <Star key={i} className="w-3.5 h-3.5 fill-[#0A1A33] text-[#0A1A33]" />
//                 ))}
//               </div>
...
//                     <h2 className="text-3xl font-bold tracking-tight text-[#0A1A33]">For Facilities</h2>
...
//                     </p>
//                   </div>
//                   <div className="mt-auto pt-4 flex items-center gap-2 text-[#0A1A33] font-bold group-hover:text-white">
...
//                 <div className="flex flex-col h-full gap-6">
//                   <div className="w-14 h-14 bg-[#1E3A8A]/20 rounded-2xl flex items-center justify-center text-[#0A1A33] group-hover:bg-[#38BDF8] group-hover:text-white transition-all duration-500">
//                     <ShoppingBag className="w-7 h-7" />
//                   </div>
//                   <div className="space-y-3">
//                     <h2 className="text-3xl font-bold tracking-tight text-[#0A1A33]">For Patients</h2>
//                     <p className="text-lg text-slate-700 leading-relaxed">
//                       Shop premium respiratory supplies with AI guidance. Simple checkout, medical trust, and expert support.
//                     </p>
//                   </div>
//                   <div className="mt-auto pt-4 flex items-center gap-2 text-[#38BDF8] font-bold group-hover:text-white">
